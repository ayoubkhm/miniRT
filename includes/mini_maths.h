...
void set_hit_info_plane(t_hit *hit, t_plane *plane, t_ray ray, double t_val);
...
void    compute_hyp_transform_params(t_hyperboloid *h, t_vec *rot, double *ang);
...
void            compute_parab_hit_geometry(t_parabint *I, double t, t_vec *point, t_vec *normal);
void            set_parab_hit(t_parabint *I, double t, t_hit *h);
bool            intersect_paraboloid(t_vec ro, t_vec rd, t_paraboloid *p, t_hit *hit);
void            compute_parab_transform_params(t_paraboloid *p, t_vec *rot, double *ang);
